	...
	export default {
		...
		methods: {
			getNewsList(event) {
				...
				this.axios.get("/irs/rcd?cid=56&ext=" + this.currentType +
					"&token=c786875b8e04da17b24ea5e332745e0f&num=5&expIds=20190106A13PFT%7C20190108A04MLS&page=" + this.currentpage).then(
					(res) => {
